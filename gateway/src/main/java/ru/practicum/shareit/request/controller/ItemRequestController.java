...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<Object> addItemRequest(@RequestHeader("X-Sharer-User-Id") @NotNull Long userId,
    ...
    @GetMapping
    public ResponseEntity<Object> getAllItemRequestsUser(@RequestHeader("X-Sharer-User-Id") @NotNull Long userId) {
        log.info("Get all itemRequest for user, userId={}", userId);
        return itemRequestClient.getAllItemRequestsUser(userId);
    }

    @GetMapping("/all")
    public ResponseEntity<Object> getAllItemRequests(@RequestHeader("X-Sharer-User-Id") @NotNull Long userId,
    ...
    public ResponseEntity<Object> getItemRequestById(@PathVariable @NotNull Long requestId,
